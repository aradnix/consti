...
\setuphead[chapter][style=\bf, page={yes,header,footer,right},
sectionsegments=chapter, number=yes, numbercommand=Título~]
...
\setuphead[subsubsection][style=\bf, number=yes, alternative=text, sectionsegments=subsubsection, numbercommand=Artículo~]
...
\startalignment[center]
  \blank[2*big]
    {\tfd Constitución Política de la\\ República Mexicana}
  \blank[3*medium]
